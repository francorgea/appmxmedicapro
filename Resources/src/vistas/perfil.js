...
function MostrarDatos(win, json) {
	...
	if (!params.isAndroid) {
		...
		for (x = 0; x <= 6; x++) {
			...
			navButtons[x].addEventListener('click', function(e) {
				...
				switch (indiceInput) {
					case 0:
						jIdentificacion.input.focus();
						break;
					case 1:
						jNombres.input.focus();
						break;
					case 2:
						jApellidos.input.focus();
						break;
					case 3:
						jTelefono.input.focus();
						break;
					case 4:
						jEmail.input.focus();
						break;
    ...
    */
	...
	jIdentificacion.input.addEventListener('focus', function() {
		indiceInput = 0;
	});
    ...
    */
	...
	jNombres.input.addEventListener('focus', function() {
		indiceInput = 1;
	});
	...
	jApellidos.input.addEventListener('focus', function() {
		indiceInput = 2;
	});
	...
	jTelefono.input.addEventListener('focus', function() {
		indiceInput = 3;
	});
	...
	jEmail.input.addEventListener('focus', function() {
		indiceInput = 4;
	});
